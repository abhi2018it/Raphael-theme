...
$tmpl->addItem( 'switcher', array( 'label' => __( 'Rotation', 'rap' ), 'name' => 'tp_home_slider_rotating'));
$tmpl->addItem( 'text', array( 'label' => __( 'Rotating time', 'rap'), 'help'=>__('Slider rotating time in seconds', 'rap') , 'name' => 'tp_home_slider_rotating_time'));
...
$tmpl->addItem( 'uploadImgCrop', [ 'label' => __( 'Banner #{{math @index "+" 1}} mobile (recommended size: 600*600px)', 'dali' ), 'crop_name' => 'slider_home{{@index}}_adap', 'name' => 'slider_home[{{@index}}][img_adap]', 'value' =>'{{img_adap}}', 'width' => 600, 'height' => 600 ] );
