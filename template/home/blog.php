        ...
        <div class="container">
            ...
            <div class="slider-blog">
                <?php while ( have_posts() ) :	the_post();
                    ...
                    <div>
                        <div class="blog-item">
                            <?php printf('<div class="blog-thumb"><div class="thumb"><a href="%s"><div class="bg" style="background-image: url(%s?1000)"></div></a></div></div>', get_the_permalink(), theme_thumb_photo_url($post->ID, 'medium')) ?>
